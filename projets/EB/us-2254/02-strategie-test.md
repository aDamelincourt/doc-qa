# [MCP][Tools] CRU customer - Stratégie de Test

## 📋 Informations générales

- **Feature** : [MCP][Tools] CRU customer
- **User Story** : EB-2254 : [MCP][Tools] CRU customer
...
Valider de bout en bout la fonctionnalité **[MCP][Tools] CRU customer** en s'assurant qu'elle répond aux critères d'acceptation et ne provoque pas de régression sur les fonctionnalités existantes de la marketing sheet.
...
- **User Story** : https://forge.prestashop.com/browse/EB-2254
