# [Products] - I want to provide Module Benefits - Stratégie de Test
...
As a module seller, I want to select the allowed number of benefits from a predefined list so that I can highlight their advantages for customers.&#160;

**User Stories couvertes** :

- SPEX-3143 : As a module seller, I want to select the allowed number of benefits from a predefined list so that I can highlight their advantages for customers.&#160;
...
Valider de bout en bout la fonctionnalité **[Products] - I want to provide Module Benefits** en s'assurant qu'elle répond aux critères d'acceptation et ne provoque pas de régression sur les fonctionnalités existantes de la marketing sheet.
