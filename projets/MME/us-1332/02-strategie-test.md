# [Billing UI] Impossible de lancer un abonnement avec code promo - Stratégie de Test

## 📋 Informations générales

- **Feature** : [Billing UI] Impossible de lancer un abonnement avec code promo
- **User Story** : MME-1332 : [Billing UI] Impossible de lancer un abonnement avec code promo
- **Sprint/Version** : [ex: Sprint 24, v2.3.0]
- **Date de création** : 2025-11-18
- **Auteur** : [Nom du QA]
- **Statut** : Draft
- **Lien Jira/Ticket** : https://forge.prestashop.com/browse/MME-1332
...
Valider de bout en bout la fonctionnalité **[Billing UI] Impossible de lancer un abonnement avec code promo** en s'assurant qu'elle répond aux critères d'acceptation et ne provoque pas de régression sur les fonctionnalités existantes de la marketing sheet.
...
- **User Story** : https://forge.prestashop.com/browse/MME-1332
