# [MCP][Tools] CRU orders - Stratégie de Test

## 📋 Informations générales

- **Feature** : [MCP][Tools] CRU orders
- **User Story** : EB-2253 : [MCP][Tools] CRU orders
...
Valider de bout en bout la fonctionnalité **[MCP][Tools] CRU orders** en s'assurant qu'elle répond aux critères d'acceptation et ne provoque pas de régression sur les fonctionnalités existantes de la marketing sheet.
...
- **User Story** : https://forge.prestashop.com/browse/EB-2253
