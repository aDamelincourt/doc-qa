# Segment Profiles Enrichment with Reverse ETL - Cas de Test

## 📋 Informations générales

- **Feature** : Segment Profiles Enrichment with Reverse ETL
- **User Story** : DATA-3873 : Segment Profiles Enrichment with Reverse ETL
- **Sprint/Version** : [ex: Sprint 24, v2.3.0]
- **Date de création** : 2025-11-18
- **Auteur** : [Nom du QA]
- **Statut** : Draft
- **Lien Jira/Ticket** : https://forge.prestashop.com/browse/DATA-3873
...
### Scénario 1 : Identification des données

**Objectif** : Vérifier que Identification des données

**Étapes** :

1. Se connecter et accéder à la fonctionnalité
2. je consulte la documentation de l'analyse,
...
### Scénario 2 : Configuration du mapping avec PS Account ID

**Objectif** : Vérifier que Configuration du mapping avec PS Account ID

**Étapes** :

1. Se connecter et accéder à la fonctionnalité
2. je définis le mapping entre le data warehouse et Segment,
...
### Scénario 3 : Enrichissement des profils Segment

**Objectif** : Vérifier que Enrichissement des profils Segment

**Étapes** :

1. Se connecter et accéder à la fonctionnalité
2. les données sont poussées vers Segment,
...
### Scénario 4 : Validation de l'enrichissement

**Objectif** : Vérifier que Validation de l'enrichissement

**Étapes** :

1. Se connecter et accéder à la fonctionnalité
2. je consulte un profil Segment,
...
- **Ticket** : https://forge.prestashop.com/browse/DATA-3873
