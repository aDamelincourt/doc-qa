# Map Warehouse to Data Graph for Linked Audiences (Beta) - Stratégie de Test

## 📋 Informations générales

- **Feature** : Map Warehouse to Data Graph for Linked Audiences (Beta)
- **User Story** : DATA-3872 : Map Warehouse to Data Graph for Linked Audiences (Beta)
...
Valider de bout en bout la fonctionnalité **Map Warehouse to Data Graph for Linked Audiences (Beta)** en s'assurant qu'elle répond aux critères d'acceptation et ne provoque pas de régression sur les fonctionnalités existantes de la marketing sheet.
...
- **User Story** : https://forge.prestashop.com/browse/DATA-3872
