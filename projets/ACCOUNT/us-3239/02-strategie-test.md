# [Admin UI] Listing des stores v8 + filtre generale de la page - Stratégie de Test
...
Valider de bout en bout la fonctionnalité **[Admin UI] Listing des stores v8 + filtre generale de la page** en s'assurant qu'elle répond aux critères d'acceptation et ne provoque pas de régression sur les fonctionnalités existantes de la marketing sheet.
...
- **User Story** : https://forge.prestashop.com/browse/ACCOUNT-3239
