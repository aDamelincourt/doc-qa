# SPIKE / PREPA: Interface de gestion pour autonomie du support - Cas de Test
...
### Scénario 1 : Infrastructure de base déployée

**Objectif** : Vérifier que Infrastructure de base déployée

**Étapes** :

1. Se connecter et accéder à la fonctionnalité
2. la phase de préparation est terminée,
...
### Scénario 2 : Authentification fonctionnelle

**Objectif** : Vérifier que Authentification fonctionnelle

**Étapes** :

1. Se connecter et accéder à la fonctionnalité
2. le déploiement initial est effectué,
...
### Scénario 3 : Actions support définies

**Objectif** : Vérifier que Actions support définies

**Étapes** :

1. Se connecter et accéder à la fonctionnalité
2. l'analyse est complétée,
...
### Scénario 4 : Ticket de développement créé

**Objectif** : Vérifier que Ticket de développement créé

**Étapes** :

1. Se connecter et accéder à la fonctionnalité
2. la phase d'exploration est terminée,
...
- **Ticket** : https://forge.prestashop.com/browse/ACCOUNT-3182
